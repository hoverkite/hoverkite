...
impl Register {
    ...
    pub fn to_memory_address(&self) -> u8 {
        match self {
            Self::FirmwareMajorVersionNumber => 0,
            Self::FirmwareSubVersionNumber => 1,
            Self::ServoMainVersionNumber => 3,
            Self::ServoSubVersionNumber => 4,
            Self::ID => 5,
            Self::BaudRate => 6,
            Self::ReturnDelay => 7,
            Self::ResponseStatusLevel => 8,
            Self::MinimumAngleLimitation => 9,
            Self::MaximumAngleLimitation => 11,
            Self::MaximumTemperatureLimit => 13,
            Self::MaximumInputVoltage => 14,
            Self::MinimumInputVoltage => 15,
            Self::MaximumTorque => 16,
            Self::Phase => 18,
            Self::UnloadingCondition => 19,
            Self::LEDAlarmCondition => 20,
            Self::ProportionalityCoefficient => 21,
            Self::DifferentialCoefficient => 22,
            Self::IntegralCoefficient => 23,
            Self::MinimumStartupForce => 24,
            Self::ClockwiseInsensitiveArea => 26,
            Self::CounterclockwiseInsensitiveRegion => 27,
            Self::ProtectionCurrent => 28,
            Self::AngularResolution => 30,
            Self::PositionCorrection => 31,
            Self::OperationMode => 33,
            Self::ProtectiveTorque => 34,
            Self::ProtectionTime => 35,
            Self::OverloadTorque => 36,
            Self::SpeedClosedLoopPProportionalCoefficient => 37,
            Self::OverCurrentProtectionTime => 38,
            Self::VelocityClosedLoopIIntegralCoefficient => 39,
            Self::TorqueSwitch => 40,
            Self::Acceleration => 41,
            Self::TargetLocation => 42,
            Self::RunningTime => 44,
            Self::RunningSpeed => 46,
            Self::TorqueLimit => 48,
            Self::LockMark => 55,
            Self::CurrentLocation => 56,
            Self::CurrentSpeed => 58,
            Self::CurrentLoad => 60,
            Self::CurrentVoltage => 62,
            Self::CurrentTemperature => 63,
            Self::AsynchronousWriteFlag => 64,
            Self::ServoStatus => 65,
            Self::MobileSign => 66,
            Self::CurrentCurrent => 69,
        }
    }
